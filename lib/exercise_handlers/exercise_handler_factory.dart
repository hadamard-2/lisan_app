...
import 'package:lisan_app/exercise_handlers/picture_multiple_choice_handler.dart';
  ...
  static ExerciseHandler createHandler(Map<String, dynamic> exercise) {
    switch (exercise['type']) {
      ...
      case 'complete_sentence':
        return CompleteSentenceHandler(
          CompleteSentenceExerciseData.fromJson(exercise),
        );
      case 'fill_in_blank':
      ...
      case 'picture_multiple_choice':
        return PictureMultipleChoiceHandler(
          PictureMultipleChoiceExerciseData.fromJson(exercise),
        );
      default:
